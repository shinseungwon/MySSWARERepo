...
const registerTree = function (tag, dataurl) {
    ...
    var setChild = function (element, obj) {
        ...
        if (obj.child !== undefined) {
            ...
            img.setAttribute("src", src + "/Images/expand.png");
            img.addEventListener("click", function () {
                this.parentElement.querySelector(".nested").classList.toggle("active");

                if (this.getAttribute("src") === src + "/Images/expand.png")
                    this.setAttribute("src", src + "/Images/nested.png");
                else
                    this.setAttribute("src", src + "/Images/expand.png");
            });
